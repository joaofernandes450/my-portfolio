...
export class HomepageComponent implements OnInit {
  ...
  projects: Project[] = [
    {
      title: [{ locale: 'en', text: "eGYM: Engineer's Gym" }, { locale: 'pt', text: "eGYM: Engineer's Gym" }], imageURL: "/src/assets/images/eGYM Languages.png",
    ...
    {
      title: [{ locale: 'en', text: "eGYM: Engineer's Gym" }, { locale: 'pt', text: "eGYM: Engineer's Gym" }], imageURL: "/src/assets/images/eGYM PESTI.png",
